<nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #343A40">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="{{ route('admin') }}">Công ty ABC</a>
    <!-- Sidebar Toggle-->
    ...
    <form action="{{ route('adminTimkiem') }}" method="post" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
        ...
        <div class="input-group">
            <input class="form-control" name="txtSearch" type="text" placeholder="Tìm kiếm ..." aria-label="Search for..." aria-describedby="btnNavbarSearch" />
